...
We will look at a rather challenging case study on the detection of rock glaciers in the Chilean Andes from a combination of 40 texture features and 6 terrain attributes. This is how a rock glacier looks like - it resemles a lava stream more than a glacier:
...
<img src="figuresplotale-1.png" title="plot of chunk plotale" alt="plot of chunk plotale" width="100%" style="display: block; margin: auto;" />
...
$$
that re-express the features in our dataset in a way that makes sense to us as domain scientists. PCA seems reasonable here, but other transformations can be considered (some thoughts on this in the paper).
...
<img src="figuresstrucpcaimp10plot-1.png" title="plot of chunk strucpcaimp10plot" alt="plot of chunk strucpcaimp10plot" width="50%" style="display: block; margin: auto;" />
...
<img src="figuresstrucpcaaleplot-1.png" title="plot of chunk strucpcaaleplot" alt="plot of chunk strucpcaaleplot" width="80%" style="display: block; margin: auto;" />
...
<img src="figuresstrucpcapdp2plot-1.png" title="plot of chunk strucpcapdp2plot" alt="plot of chunk strucpcapdp2plot" width="50%" style="display: block; margin: auto;" />
